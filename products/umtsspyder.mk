...
DEVICE_PACKAGE_OVERLAYS += vendor/ska/overlay/umts_spyder

# Setup device specific product configuration.
PRODUCT_NAME := ska_umtsspyder
PRODUCT_BRAND := moto
...
PRODUCT_COPY_FILES +=  \
    vendor/ska/prebuilt/bootanimation/bootanimation_540_960.zip:system/media/bootanimation-alt.zip
